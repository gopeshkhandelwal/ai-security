...
show_next_steps() {
    ...
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  OPTION A: Run demo on ANY VM (shows both scenarios)"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    ...
    echo "  python3 2_memory_comparison_demo.py --demo   # Shows BOTH scenarios"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  OPTION B: Run on BOTH VMs to see real difference"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "  # TDX VM (should show: PROTECTED)"
    echo "  gcloud compute ssh $TDX_VM_NAME --zone=$ZONE --tunnel-through-iap"
    echo "  python3 2_memory_comparison_demo.py"
    echo ""
    echo "  # Standard VM (should show: VULNERABLE)"
