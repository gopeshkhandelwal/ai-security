...
## Part 3: Create Standard VM (No Protection)

This VM has NO memory encryption - demonstrates the vulnerability.
...
## Part 4: Create TDX Confidential VM
